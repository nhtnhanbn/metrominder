...
if (storageAvailable("sessionStorage")) {
    ...
    if (sessionStorage.getItem("indexBounds")) {
        map.fitBounds(
            Object.values(JSON.parse(sessionStorage.getItem("indexBounds"))),
            { animate: false }
        );
    }
    ...
    setInterval(() => {
        ...
        sessionStorage.setItem("indexBounds", JSON.stringify(map.getBounds()));
    }, 1000);
} else {
    setDefaultRoutes();
}