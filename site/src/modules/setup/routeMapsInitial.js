...
const metroTrainRouteMaps = new Set([
    ...
    new MetroTrainRouteMap("RCE", ["1.1.R", "27.2.R"]),
    new MetroTrainRouteMap("CCL", ["53.1.H"])
]);

const regionTrainRouteMaps = new Set([
    new RegionTrainRouteMap("ABY", ["9.2.R"]),
    new RegionTrainRouteMap("ART", ["9.2.R"]),
    new RegionTrainRouteMap("BAT", ["9.5.R"]),
    new RegionTrainRouteMap("BDE", ["9.3.R"]),
    new RegionTrainRouteMap("BGO", ["9.2.R"]),
